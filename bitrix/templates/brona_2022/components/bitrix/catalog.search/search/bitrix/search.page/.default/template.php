...
<?else:?>
  <div class="search__inputs search__catalog">
  <div class="input__text">
  <input type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="70" class="search__form-input" placeholder="Поиск"/>
  </div>
<?endif;?>
<span class="search__input-submit">
  <input type="submit" value="" class="search__form-submit"/>
