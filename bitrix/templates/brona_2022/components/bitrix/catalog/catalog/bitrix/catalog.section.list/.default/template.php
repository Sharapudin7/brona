...
<?
	switch ($arParams['VIEW_MODE'])
	{
        ...
        <li class="catalog__categories-item" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
				<a
					href="<? echo $arSection['SECTION_PAGE_URL']; ?>"
				...
				{
					?><h2 class="catalog__categories-name"><a href="<? echo $arSection['SECTION_PAGE_URL']; ?>"><? echo $arSection['NAME']; ?></a><?
					if ($arParams["COUNT_ELEMENTS"])
					{
						?><?
					}
