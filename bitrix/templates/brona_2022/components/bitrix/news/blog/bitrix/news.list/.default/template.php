...
<div class="blog">
  <div class="container">
	...
	?>
    <div class="col-md-12 col-lg-6 blog__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
      <?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
      <?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
      <a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><img class="blog__item-img"
      ...
      <?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
      <div class="blog__item-name"><a href="<?=$arItem["DETAIL_PAGE_URL"]?>">
          <?echo $arItem["NAME"]?>
        </div></a>
      <?endif;?>
      <?endif;?>
