          ...
          <h1 class="bx-title"><?=$name?></h1>
                  ...
                  case 'price':
                      ...
                      <div class="product-item-detail-info-container">
											...
											<div class="product-item-detail-block" id="<?=$itemIds['TREE_ID']?>">
												<?
								...
								switch ($blockName)
								{
									...
									case 'buttons':
										...
										<div data-entity="main-button-container">
											<div class="m1" id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
												<?
												if ($showAddBtn)
												{
													?>
												...
												if ($showBuyBtn)
												{
													?>
													<div class="product-item-detail-info-container">
                            <div class="product-item-detail-cart">
                        
														<a class="btn-cart <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>" href="javascript:void(0)"
            rel="nofollow">
            <span>
                              <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.2967 17C15.74 17 16.0994 16.6337 16.0994 16.1818V2.80769L16.0995 2.79328C16.0995 2.56141 16.0049 2.35207 15.8529 2.20319L12.9454 -0.76036C12.7949 -0.913799 12.5907 -1 12.3778 -1H3.62104C3.40815 -1 3.20397 -0.913799 3.05344 -0.76036L0.13452 2.21485C0.112525 2.23727 0.091938 2.26085 0.0728174 2.28546C-0.0123886 2.39504 -0.0706378 2.52738 -0.0917177 2.67208C-0.0975885 2.712 -0.100586 2.75254 -0.100586 2.79339V16.1818C-0.100586 16.6337 0.258796 17 0.702117 17H15.2967ZM12.0455 0.634766L13.3605 1.9751H2.6388L3.95377 0.634766H12.0455ZM14.4943 3.61146H1.50507V15.362H14.4943V3.61146ZM7.99945 9.41188C9.59937 9.41188 10.8454 8.14183 10.8454 6.51105C10.8454 6.05918 11.2048 5.69287 11.6481 5.69287C12.0914 5.69287 12.4508 6.05918 12.4508 6.51105C12.4508 9.04557 10.486 11.0482 7.99945 11.0482C5.51288 11.0482 3.5481 9.04557 3.5481 6.51105C3.5481 6.05918 3.90748 5.69287 4.3508 5.69287C4.79412 5.69287 5.1535 6.05918 5.1535 6.51105C5.1535 8.14183 6.39952 9.41188 7.99945 9.41188Z" fill="white"/>
                              </svg></span>
            <span class="btn-cart-name">
            <?=($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? $arParams['MESS_BTN_BUY'] : $arParams['MESS_BTN_ADD_TO_BASKET'])?>
                          ...
                          <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M14.6265 8.89374C16.4598 6.95036 16.4598 3.79935 14.6265 1.85597C12.7979 -0.0825509 9.83577 -0.0873951 8.00146 1.84144C6.16716 -0.0873951 3.20502 -0.0825509 1.37638 1.85597C-0.456841 3.79935 -0.456841 6.95036 1.37638 8.89374L7.48646 15.3724C7.77048 15.6735 8.23104 15.6736 8.51509 15.3724L14.6265 8.89374ZM13.598 7.80335L8.00086 13.7368L2.40502 7.80341C1.13981 6.46218 1.13981 4.28753 2.40496 2.94636C3.67012 1.60519 5.72149 1.60519 6.98665 2.94636C7.13874 3.1076 7.27541 3.28551 7.39545 3.47725C7.68315 3.93685 8.31978 3.93685 8.60748 3.47725C8.72773 3.28516 8.86378 3.10802 9.01628 2.94636C10.2814 1.60519 12.3328 1.60519 13.598 2.94636C14.8631 4.28753 14.8631 6.46218 13.598 7.80335Z" fill="black"/>
                            <mask id="mask0_614_18206" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="17" height="16">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M14.6265 8.89374C16.4598 6.95036 16.4598 3.79935 14.6265 1.85597C12.7979 -0.0825509 9.83577 -0.0873951 8.00146 1.84144C6.16716 -0.0873951 3.20502 -0.0825509 1.37638 1.85597C-0.456841 3.79935 -0.456841 6.95036 1.37638 8.89374L7.48646 15.3724C7.77048 15.6735 8.23104 15.6736 8.51509 15.3724L14.6265 8.89374ZM13.598 7.80335L8.00086 13.7368L2.40502 7.80341C1.13981 6.46218 1.13981 4.28753 2.40496 2.94636C3.67012 1.60519 5.72149 1.60519 6.98665 2.94636C7.13874 3.1076 7.27541 3.28551 7.39545 3.47725C7.68315 3.93685 8.31978 3.93685 8.60748 3.47725C8.72773 3.28516 8.86378 3.10802 9.01628 2.94636C10.2814 1.60519 12.3328 1.60519 13.598 2.94636C14.8631 4.28753 14.8631 6.46218 13.598 7.80335Z" fill="white"/>
                            </mask>
                            <g mask="url(#mask0_614_18206)">
                            </g>
                            </svg>
                          </div> -->
													<?
