...
<div class="container">
  <div class="product-item">
    ...
    <div class="product__item-wrap">
      <a href="#" class="product__item-favorite">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd"
            d="M14.1174 8.49263C15.8658 6.63922 15.8658 3.63409 14.1174 1.78068C12.3734 -0.0680955 9.54845 -0.0727154 7.79906 1.76682C6.04968 -0.0727154 3.22468 -0.0680955 1.4807 1.78068C-0.267654 3.63409 -0.267654 6.63922 1.4807 8.49263L7.3079 14.6713C7.57877 14.9585 8.01801 14.9586 8.28891 14.6714L14.1174 8.49263ZM13.1365 7.45309L7.79857 13.1118L2.4618 7.45315C1.25516 6.17401 1.25516 4.10004 2.46174 2.82096C3.66832 1.54188 5.62473 1.54188 6.83131 2.82096C6.97637 2.97473 7.10671 3.14441 7.22118 3.32728C7.49557 3.76559 8.10272 3.76559 8.37711 3.32728C8.49179 3.14407 8.62154 2.97514 8.76698 2.82096C9.97356 1.54188 11.93 1.54188 13.1365 2.82096C14.3431 4.10004 14.3431 6.17401 13.1365 7.45309Z"
            fill="black" />
          <mask id="mask0_943_13347" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="16"
            height="15">
            <path fill-rule="evenodd" clip-rule="evenodd"
              d="M14.1174 8.49263C15.8658 6.63922 15.8658 3.63409 14.1174 1.78068C12.3734 -0.0680955 9.54845 -0.0727154 7.79906 1.76682C6.04968 -0.0727154 3.22468 -0.0680955 1.4807 1.78068C-0.267654 3.63409 -0.267654 6.63922 1.4807 8.49263L7.3079 14.6713C7.57877 14.9585 8.01801 14.9586 8.28891 14.6714L14.1174 8.49263ZM13.1365 7.45309L7.79857 13.1118L2.4618 7.45315C1.25516 6.17401 1.25516 4.10004 2.46174 2.82096C3.66832 1.54188 5.62473 1.54188 6.83131 2.82096C6.97637 2.97473 7.10671 3.14441 7.22118 3.32728C7.49557 3.76559 8.10272 3.76559 8.37711 3.32728C8.49179 3.14407 8.62154 2.97514 8.76698 2.82096C9.97356 1.54188 11.93 1.54188 13.1365 2.82096C14.3431 4.10004 14.3431 6.17401 13.1365 7.45309Z"
              fill="white" />
          </mask>
          <g mask="url(#mask0_943_13347)">
          </g>
        </svg>
      </a>
      <a class="product-item-image-wrapper" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>"
        ...
        <span class="product-item-image-wrapper" data-entity="image-wrapper">
          ...
          <span class="product-item-image-slider-slide-container slide" id="<?=$itemIds['PICT_SLIDER']?>"
            <?=($showSlider ? '' : 'style="display: none;"')?> data-slider-interval="<?=$arParams['SLIDER_INTERVAL']?>"
  ...
  <div class="product__item-bottom">
    ...
    <div class="product-item-info-container product-item-hidden" data-entity="buttons-block">
      ...
      <div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
        <a class="btn btn-default <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>" href="javascript:void(0)"
          rel="nofollow">
      ...
      <div class="product-item-button-container">
        <?
									...
									?>
        <a class="btn btn-link <?=$buttonSizeClass?>" id="<?=$itemIds['NOT_AVAILABLE_MESS']?>" href="javascript:void(0)"
          rel="nofollow">
      ...
      <div class="product-item-button-container">
        <?
									...
									?>
        <a class="btn btn-link <?=$buttonSizeClass?>" id="<?=$itemIds['NOT_AVAILABLE_MESS']?>" href="javascript:void(0)"
          rel="nofollow" <?=($actualItem['CAN_BUY'] ? 'style="display: none;"' : '')?>>
          <?=$arParams['MESS_NOT_AVAILABLE']?>
        </a>
        ...
        <tr>
          ...
          <td>
            ...
            <label>
              ...
              <input type="radio" name="<?=$arParams['PRODUCT_PROPS_VARIABLE']?>[<?=$propID?>]" value="<?=$valueID?>"
                <?=$checked?>>
              <?=$value?>
            </label>
            <br />
    ...
    <?
				...
				case 'sku':
					...
					{
						?>
    <div class="item__product-colors" id="<?=$itemIds['PROP_DIV']?>">
      <p class="item__product-options">3 варианта цвета</p>
      <?
