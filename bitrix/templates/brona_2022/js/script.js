...
defaults = {
  ...
  openClass: 'open',
  defaultOpenClass: 'default-close',
...
$('.header-mob__burger').click(function() {
  ...
  $('.header-mob__dropdown').toggleClass('show')
  $('body').toggleClass('not-scroll');
});
})

$(function() {
$(".contacts__tabs .tab").click(function() {
	$(".contacts__tabs .tab").removeClass("active").eq($(this).index()).addClass("active");
...
$(function() {
$('.search-block__hide').click(function() {
